export default {
  ...
  filter_category_text:
    "Elke hersteloptie heeft zijn eigen specialiteiten, do's en dont's. Filter de lijst op de productcategorie waarvoor u een hersteloptie in uw regio wilt vinden.",
